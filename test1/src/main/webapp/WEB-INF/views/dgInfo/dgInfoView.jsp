...
<!-- 								<form> -->
									...
									<input id="demo-inline-form-radio-3" class="magic-radio" type="radio" name="inline-form-radio" onclick="sido(6270000)"> 
										<label for="demo-inline-form-radio-3">대구 광역시</label> 
									<input id="demo-inline-form-radio-3" class="magic-radio" type="radio" name="inline-form-radio" onclick="sido(6280000)"> 
										<label for="demo-inline-form-radio-3">인천 광역시</label> 
									<input id="demo-inline-form-radio-3" class="magic-radio" type="radio" name="inline-form-radio" onclick="sido(6290000)"> 
										<label for="demo-inline-form-radio-3">광주 광역시</label> 
									<input id="demo-inline-form-radio-3" class="magic-radio" type="radio" name="inline-form-radio" onclick="sido(5690000)"> 
										<label for="demo-inline-form-radio-3">세종 특별 자치시</label> 
									<input id="demo-inline-form-radio-3" class="magic-radio" type="radio" name="inline-form-radio" onclick="sido(6300000)"> 
										<label for="demo-inline-form-radio-3">대전 광역시</label> 
									<input id="demo-inline-form-radio-3" class="magic-radio" type="radio" name="inline-form-radio" onclick="sido(6310000)"> 
										<label for="demo-inline-form-radio-3">울산 광역시</label> 
									<input id="demo-inline-form-radio-3" class="magic-radio" type="radio" name="inline-form-radio" onclick="sido(6420000)"> 
										<label for="demo-inline-form-radio-3">강원도</label>
<!-- 								</form> -->
							</div>
							<div id="gungu"></div>
...
<!-- 			</div> -->
			...
			<div id="whitepanel">
				<div id="test">
				 <div class="row">
					        <div id="a" class="col-sm-4 col-md-3">
		        ...
		        str='<div class="btn-group">'+
                    '<div class="dropdown">'+
                        ...
                        '<ul class="dropdown-menu dropdown-menu-right">'+
                            '<li class="dropdown-header">구 선택</li>';
	...
	function sigungu(si,gungu){ // 구 코드 보내기
		...
		$.ajax({          
		    ...
		    success: function(data){
		        ...
		        for(var i=0;i<a.length;++i){
				str+='<div  id="ex"class="panel pos-rel">'+
            		...
            		'</div>'+
            		'<a href="#">'+
                	'<img alt="Profile Picture" class="img-lg img-circle mar-ver" src="'+a[i].popfile+'">'+
