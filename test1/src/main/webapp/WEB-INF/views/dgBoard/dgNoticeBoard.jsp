                       ...
                       <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                           <thead>
                               <tr>
                                   ...
                                   <th style="width:56%" class="min-tablet">Title</th>
                                   <th style="width:14%" >ID</th>
                                   <th style="width:12%" class="min-tablet">Created</th>
                                   <th style="width:12%" class="min-desktop">Modified </th>
                               </tr>
                           </thead>
                           <tbody>
                           <c:forEach var="dgNoticeBoardList" items="${ dgNoticeBoardList }">
                               <tr>
                                  <td>${ dgNoticeBoardList.dg_board_no }</td>
       							  <td>${ dgNoticeBoardList.dg_board_title }</td>
       							  <td>${ dgNoticeBoardList.dg_board_user_id }</td>
       							  <td>${ dgNoticeBoardList.dg_board_created }</td>
       							  <td>${ dgNoticeBoardList.dg_board_modified }</td>
                               </tr>
                           </c:forEach>
